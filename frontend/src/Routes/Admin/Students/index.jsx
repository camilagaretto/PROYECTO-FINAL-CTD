...
function Students () {
    ...
    const fetchData = async () => {
        ...
        try {
          const response = await fetch('ec2-107-21-139-55.compute-1.amazonaws.com/v1/categories/1/customers/search', {
            method:'POST',
            headers: {
    ...
    const __handleRol = async (student) => {
        ...
        try {
            const response = await fetch(`ec2-107-21-139-55.compute-1.amazonaws.com/v1/auth/${student.userId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
