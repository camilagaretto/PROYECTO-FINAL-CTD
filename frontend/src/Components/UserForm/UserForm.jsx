...
const UserForm = () => {
  ...
  const handleSubmitForm = async (values) => {
    ...
    try {
      const response = await fetch('ec2-107-21-139-55.compute-1.amazonaws.com/v1/auth/register', {
        method: 'POST',
        headers: {
  ...
  const createStudent = async (userId, values, token) => {
    ...
    try {
      const response = await fetch('ec2-107-21-139-55.compute-1.amazonaws.com/v1/categories/1/customers/', {
        method: 'POST',
        mode: 'cors',
        headers: {
          'Content-Type': 'application/json',
