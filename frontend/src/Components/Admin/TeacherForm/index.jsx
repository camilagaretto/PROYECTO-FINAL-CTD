...
function TeacherForm() {
    ...
    const handleSubmit = async (event) => {
        ...
        ? `ec2-107-21-139-55.compute-1.amazonaws.com/v1/categories/1/providers/${params.id}`
        : 'ec2-107-21-139-55.compute-1.amazonaws.com/v1/categories/1/providers/';
    ...
    const getCharacteristics = async () => {
        ...
        try {
            const response = await fetch('ec2-107-21-139-55.compute-1.amazonaws.com/v1/categories/1/providers/characteristics/search', {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
